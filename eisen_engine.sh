...
sudo apt-get install -y python-pip python-crypto python-dev rabbitmq-server sshpass python-mysqldb dos2unix build-essential libssl-dev libffi-dev python-dev > /dev/null 2>&1
