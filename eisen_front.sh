...
rm -rf /var/www
ln -fs /vagrant/eisen_front/webd /var/www
...
echo -e "\n--- Updating css ---\n"
gem install compass
cd /vagrant/eisen_front/webd
compass compile
cd /vagrant/eisen_front/

echo -e "\n--- Creating a symlink for future phpunit use ---\n"
ln -fs /vagrant/eisen_front/vendor/bin/phpunit /usr/local/bin/phpunit
